...
const defaults: BiconomySmartAccountContextProps = {
...
export const accountStore = writable<BiconomySmartAccountContextProps>(defaults);
...
export function useBiconomyAccountAbstraction(): Writable<
  BiconomySmartAccountContextProps
> {
  return accountStore;
}
