...
export class StargateRouter__factory {
  static readonly abi = _abi;
  static createInterface(): StargateRouterInterface {
    return new utils.Interface(_abi) as StargateRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StargateRouter {
    return new Contract(address, _abi, signerOrProvider) as StargateRouter;
  }
}
